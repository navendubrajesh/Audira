...
Decoupled GPU inference via Arq queue + shared `resonode_core` provider abstraction.

## Key paths

| Area | Files |
|---|---|
| Shared core | `services/shared/resonode_core/inference/`, `process_job.py`, `sla.py`, `cost.py` |
